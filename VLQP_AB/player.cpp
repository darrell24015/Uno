...
int rollingScore = 0;
// CHANGE: Make Heart occur 4 of 10, instead of 1 of 10 
byte pickupsAvailable[] = {PICKUP_TYPE_COIN, PICKUP_TYPE_HEART, PICKUP_TYPE_COIN, PICKUP_TYPE_HEART, PICKUP_TYPE_COIN, PICKUP_TYPE_HEART, PICKUP_TYPE_INACTIVE, PICKUP_TYPE_COIN, PICKUP_TYPE_HEART, PICKUP_TYPE_COIN};
byte pickupsCounter;
